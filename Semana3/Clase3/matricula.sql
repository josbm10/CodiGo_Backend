...
CREATE TABLE IF NOT EXISTS `db_matricula`.`tbl_matricula` (
  ...
  `matricula_fecregr` VARCHAR(45) NOT NULL COMMENT 'fecha de registro',
...
CREATE TABLE IF NOT EXISTS `db_matricula`.`tbl_matricula_curso` (
  `matricula_curso_id` INT(11) NOT NULL,
  `matricula_id` INT(11) NOT NULL,
  `profesor_id` INT(11) NOT NULL,
  `curso_id` INT(11) NOT NULL,
  PRIMARY KEY (`matricula_curso_id`),
  CONSTRAINT `fk_tdl_matricula_curso_tbl_matricula1`
    FOREIGN KEY (`matricula_id`)
    REFERENCES `db_matricula`.`tbl_matricula` (`matricula_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_tdl_matricula_curso_tbl_profesor1`
    FOREIGN KEY (`profesor_id`)
    REFERENCES `db_matricula`.`tbl_profesor` (`profesor_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_tdl_matricula_curso_tbl_curso1`
